...
>
> This is **not** a notarized Finder automount product. There are **no** official binary GitHub Releases yet. The GitHub repo is hosted for collaborators with access — clone and **build from source**.
